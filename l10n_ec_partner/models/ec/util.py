...
# --------------------------------------------------------------
# Library:  stdnum (library) for ecuador (ec)
# function: _mk_char_map(mapping)
# Notes:    Transform a dictionary with comma separated unicode 
#           character names to tuples with unicode characters as key
# --------------------------------
...
# --------------------------------------------------------------
# Library:  stdnum (library) for ecuador (ec)
# function: clean(number, deletechars='')
# Notes:    Remove the specified characters from the supplied 
#           number.
#           clean('123-456:78 9', ' -:') = '123456789'
#           clean('1–2—3―4') = '1-2-3-4'
# -------------------------------
# ----- field definition -----
...
# Notes:    Replace various Unicode characters with DELETE ASCII
#           code.
#
# function: _clean_chars(mapping)
# Notes:    Replace various Unicode characters with their ASCII
#           counterpart.
# -------------------------------

def clean(number, deletechars=''):
    # Replace various Unicode characters with DELETE ASCII code
    try:
